        ...
        <main className="flex-1 overflow-y-auto" style={{ paddingBottom: view === 'home' ? '20px' : chatOpen ? '340px' : '60px' }}>
          <div className="max-w-5xl mx-auto px-8 py-8">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="relative">
                <button onClick={() => setRoleOpen(!roleOpen)} className="h-12 px-5 rounded-xl flex items-center gap-2.5 text-sm font-semibold transition-colors border border-white/[0.1] hover:border-white/[0.2]" style={{ background: 'rgba(255,255,255,0.05)' }}>
              ...
              <button onClick={handleAnalyze} disabled={loading || !company}
                className="h-12 px-7 rounded-xl font-bold text-base transition-all flex items-center gap-2.5 disabled:opacity-30 text-white shrink-0 hover:brightness-110"
